    ...
    $("#topic-button").click(function() { //these all are for animation
        ...
        $(".view").load(`../pages/components/sub_components/input_question_header.php?subject=${subject}&chapter=${chapter}&topic=${topic}`); //sending value to input_question_header.php
