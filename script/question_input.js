...
$("#topic-button").click(function () {
  ...
  $(".view").load(
    `../pages/components/sub_components/input_question_header.php?subject=${encodeURI(
      subject
    )}&chapter=${encodeURI(chapter)}&topic=${encodeURI(topic)}`
  ); //sending value to input_question_header.php. encodeURI() is used to make sure no emty space is there
});
